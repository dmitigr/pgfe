...
#ifndef DMITIGR_OS_ERRCTG_HPP
#define DMITIGR_OS_ERRCTG_HPP
...
public:
  /// @returns The literal `dmitigr_os_wsa_error`.
  const char* name() const noexcept override
  {
    return "dmitigr_os_wsa_error";
  }
