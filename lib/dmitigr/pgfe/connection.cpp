...
DMITIGR_PGFE_API std::unique_ptr<Connection> APIENTRY Connection::make(const Connection_options* const options)
{
  if (options)
...
DMITIGR_PGFE_API void APIENTRY pgfe::set_openssl_library_initialization_enabled(const bool value)
{
...
DMITIGR_PGFE_API bool APIENTRY pgfe::is_openssl_library_initialization_enabled()
{
  return openssl_library_initialization_flag();
}

DMITIGR_PGFE_API void APIENTRY pgfe::set_crypto_library_initialization_enabled(const bool value)
{
  crypto_library_initialization_flag() = value;
  ::PQinitOpenSSL(openssl_library_initialization_flag(), crypto_library_initialization_flag());
}

DMITIGR_PGFE_API bool APIENTRY pgfe::is_crypto_library_initialization_enabled()
{
